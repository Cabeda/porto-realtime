...
const pt = {
  ...
  community: {
    subtitle: "Avaliações e propostas da comunidade",
    reviews: "Avaliações",
    proposals: "Propostas",
    trending: "Tendências",
  },
  trending: {
    title: "Tendências",
    subtitle: "O que está a acontecer na rede de transportes do Porto",
    topIssues: "Principais problemas",
    topIssuesDesc: "Alvos com pior avaliação",
    highlights: "O que funciona bem",
    highlightsDesc: "Alvos com melhor avaliação",
    trendingReviews: "Avaliações em destaque",
    trendingReviewsDesc: "Avaliações com mais votos",
    period: "Período",
  ...
  proposals: {
    ...
    shareProposal: "Partilhar",
    linkCopied: "Link copiado!",
    proposalCreated: "A tua proposta foi criada! Partilha-a para ganhar apoio.",
    // Geometry / map
    fileTooLarge: "Ficheiro demasiado grande (máx. 500KB)",
    unsupportedFormat: "Formato não suportado. Use GeoJSON, GPX ou KML.",
    parseError: "Não foi possível ler o ficheiro. Verifique o formato.",
    geoFileLabel: "Ficheiro de mapa (opcional)",
    uploadFile: "Carregar ficheiro GeoJSON, GPX ou KML",
    geoFileHelp: "Carregue um ficheiro para mostrar a rota/zona proposta no mapa.",
    loadingEntities: "A carregar...",
    selectLine: "Selecionar linha existente",
    selectBikeLane: "Selecionar ciclovia existente",
    searchEntities: "Pesquisar...",
...
const en: typeof pt = {
  ...
  community: {
    subtitle: "Community reviews and proposals",
    reviews: "Reviews",
    proposals: "Proposals",
    trending: "Trending",
  },
  trending: {
    title: "Trending",
    subtitle: "What's happening across Porto's transit network",
    topIssues: "Top issues",
    topIssuesDesc: "Lowest-rated targets",
    highlights: "What's working well",
    highlightsDesc: "Highest-rated targets",
    trendingReviews: "Trending reviews",
    trendingReviewsDesc: "Reviews with the most upvotes",
    period: "Period",
    thisWeek: "This week",
  ...
  reviews: {
    ...
    seeAll: "See all",
    backToReviews: "Back to community",
  ...
  proposals: {
    ...
    proposalCreated: "Your proposal was created! Share it to gather support.",
    // Geometry / map
    fileTooLarge: "File too large (max 500KB)",
    unsupportedFormat: "Unsupported format. Use GeoJSON, GPX or KML.",
    parseError: "Could not parse file. Check the format.",
    geoFileLabel: "Map file (optional)",
    uploadFile: "Upload GeoJSON, GPX or KML file",
    geoFileHelp: "Upload a file to show the proposed route/area on the map.",
    loadingEntities: "Loading...",
    selectLine: "Select existing line",
    selectBikeLane: "Select existing bike lane",
