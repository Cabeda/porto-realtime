...
const pt = {
  ...
  auth: {
    ...
    emailPrompt: "Introduza o seu email para receber um código de acesso.",
    emailPlaceholder: "email@exemplo.com",
    sendCode: "Enviar código",
    sending: "A enviar...",
    codeSent: "Enviámos um código de 6 dígitos para",
    verify: "Verificar",
    verifying: "A verificar...",
    changeEmail: "Alterar email",
    loginSuccess: "Sessão iniciada com sucesso!",
    invalidCode: "Código inválido ou expirado",
    rateLimited: "Demasiados pedidos. Tente novamente em alguns minutos.",
    sendError: "Erro ao enviar código. Tente novamente.",
    verifyError: "Erro na verificação. Tente novamente.",
    close: "Fechar",
    login: "Entrar",
    logout: "Sair",
...
const en: typeof pt = {
  ...
  auth: {
    loginTitle: "Sign in",
    emailPrompt: "Enter your email to receive a login code.",
    ...
    sendError: "Error sending code. Try again.",
