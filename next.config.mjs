        ...
        headers: [
          ...
          { key: "Strict-Transport-Security", value: "max-age=63072000; includeSubDomains; preload" },
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://*.tile.openstreetmap.org https://*.tile.opentopomap.org https://*.google.com https://*.googleapis.com https://*.arcgisonline.com",
              "font-src 'self'",
              "connect-src 'self' https://*.tile.openstreetmap.org https://*.tile.opentopomap.org https://*.arcgisonline.com https://otp.services.porto.digital https://opendata.porto.digital https://accounts.google.com https://*.neon.tech",
