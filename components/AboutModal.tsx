    ...
    >
      ...
      >
        ...
        <div className="space-y-4 text-content-secondary">
          <p>
            <strong>PortoMove</strong> é uma aplicação web que fornece informações de transportes
            públicos em tempo real para o Porto, Portugal.
          </p>
          ...
          <div className="text-xs text-content-muted pt-2 space-y-1">
            <p>
              Posições em tempo real: <strong>FIWARE Urban Platform</strong> (Porto Digital)
            </p>
            <p>
              Rotas e horários: <strong>OpenTripPlanner GraphQL API</strong> (Porto Digital)
            </p>
            <p>
              Dados STCP via{" "}
              <a
