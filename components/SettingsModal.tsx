      ...
      >
        ...
        <div className="px-5 py-4 space-y-5">
          ...
          <div className="border-t border-border pt-4">
            ...
            <p className="text-sm text-content-secondary mb-2">{t.settings.aboutDescription}</p>
            <p className="text-sm text-accent font-medium mb-3">{t.settings.missionStatement}</p>
            ...
            <p className="text-xs text-content-muted mb-3">{t.settings.developedBy}: José Cabeda</p>
            <a
          ...
          <div className="border-t border-border pt-4 space-y-2">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs text-content-muted">{t.settings.dataProvider}</span>
            </div>
          </div>
        </div>
      </div>
