...
```css
.dark .leaflet-tile-pane {
  filter: brightness(0.6) /* Darken */ invert(1) /* Invert colors */ contrast(3)
    /* Increase contrast */ hue-rotate(200deg) /* Adjust hue to blue */ saturate(0.3)
    /* Reduce saturation */ brightness(0.7); /* Final brightness */
}
```
